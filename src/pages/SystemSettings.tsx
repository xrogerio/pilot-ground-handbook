...
import { ImagePlus, Settings, Moon, Sun, Trash2, Save, Loader2 } from 'lucide-react'
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed mt-2">
                Escolha a cor base da sua marca. As cores de fundo, bordas e botões serão ajustadas
                automaticamente para criar uma paleta harmônica na aplicação inteira.
              </p>
            </div>
          </CardContent>
        </Card>
